...
/* Sidebar desktop recolhível + mobile offcanvas */
(()=>{
 const body=document.body;
 const menu=document.querySelector('[data-menu]');
 const close=document.querySelector('[data-menu-close]');
 const backdrop=document.querySelector('[data-menu-backdrop]');
 const key='tecnodata_crm_sidebar_collapsed';
 ...
 const toggle=()=>{
  if(isMobile()){
   ...
   if(menu)menu.setAttribute('aria-expanded',body.classList.contains('menu-open')?'true':'false');
   return;
  }
