...
include '_layout.php';?>
<div class="page-heading"><div><div class="eyebrow">COBRANÇA</div><h1>Agenda de retornos</h1><p>Somente compromissos gerados durante a cobrança.</p></div><a class="btn btn-dark" href="cobranca.php"><i class="fa-solid fa-list"></i>Carteira</a></div>
