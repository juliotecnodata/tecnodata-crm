...
CREATE TABLE IF NOT EXISTS clients(id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,omie_code VARCHAR(80) NOT NULL,name VARCHAR(190) NOT NULL,legal_name VARCHAR(190) NULL,document VARCHAR(30) NULL,email VARCHAR(1000) NULL,phone VARCHAR(40) NULL,city VARCHAR(100) NULL,uf CHAR(2) NULL,seller_omie_code VARCHAR(80) NULL,omie_seller_code VARCHAR(80) NULL,portfolio_locked TINYINT(1) NOT NULL DEFAULT 0,active TINYINT(1) NOT NULL DEFAULT 1,crm_inactive TINYINT(1) NOT NULL DEFAULT 0,crm_inactivated_at DATETIME NULL,crm_inactivated_by INT UNSIGNED NULL,raw_json JSON NULL,updated_at DATETIME NOT NULL,UNIQUE KEY uq_clients_omie(omie_code),INDEX idx_clients_name(name),INDEX idx_clients_seller(seller_omie_code,active),INDEX idx_clients_omie_seller(omie_seller_code,active),INDEX idx_clients_active(active,id),INDEX idx_clients_active_uf(active,uf),INDEX idx_clients_crm_active(crm_inactive,active,id));
