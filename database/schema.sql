...
CREATE TABLE IF NOT EXISTS service_orders(id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,omie_code VARCHAR(80) NOT NULL,client_omie_code VARCHAR(80) NULL,seller_omie_code VARCHAR(80) NULL,service_date DATE NULL,total DECIMAL(15,2) NOT NULL DEFAULT 0,status VARCHAR(40) NULL,raw_json JSON NULL,updated_at DATETIME NOT NULL,UNIQUE KEY uq_service_orders_omie(omie_code),INDEX idx_service_orders_date(service_date),INDEX idx_service_orders_seller_date(seller_omie_code,service_date));
