...
function opportunity_render(string $name,array $vars=[]): void{
 ...
 if($name==='opportunities'){
  ...
  <section class="tdopp-page">
   <header class="tdopp-head">
    <div class="tdopp-head-main"><span class="tdopp-head-icon"><i class="fa-solid fa-chart-column"></i></span><div><span class="tdopp-kicker">COMERCIAL / OPORTUNIDADES</span><h1>Pipeline de vendas</h1><p>Um fluxo curto: interesse, próxima ação e fechamento. Sem burocracia para o vendedor.</p><?php if(!empty($clientFilter)):?><a class="tdopp-filter-chip" href="<?=APP_URL?>/opportunities"><i class="fa-solid fa-filter-circle-xmark"></i>Remover filtro do cliente</a><?php endif;?></div></div>
  ...
  ?>
  <section class="tdopp-page"><a class="tdopp-back" href="<?=APP_URL?>/opportunities"><i class="fa-solid fa-arrow-left"></i>Voltar ao funil</a><header class="tdopp-head"><div class="tdopp-head-main"><span class="tdopp-head-icon"><i class="fa-solid fa-handshake"></i></span><div><span class="tdopp-kicker">OPORTUNIDADE #<?=$opp['id']?></span><h1><?=e($opp['client_name'])?></h1><p><?=e($opp['title'])?></p></div></div><div class="tdopp-detail-actions"><button class="tdopp-btn" type="button" data-global-task-open data-task-client-id="<?=(int)$opp['client_id']?>" data-task-client-name="<?=e($opp['client_name'])?>" data-task-context="sales"><i class="fa-regular fa-calendar-plus"></i>Nova tarefa</button><span class="tdopp-status <?=e($opp['status'])?>"><?=e(mb_strtoupper($opp['status']))?></span></div></header>
  ...
  ?>
  <section class="tdopp-page"><header class="tdopp-head"><div class="tdopp-head-main"><span class="tdopp-head-icon"><i class="fa-solid fa-diagram-project"></i></span><div><span class="tdopp-kicker">CONFIGURAÇÃO / COMERCIAL</span><h1>Fluxo comercial simplificado</h1><p>Você escolhe se a equipe usa o novo fluxo. Desativado, o CRM continua funcionando como hoje.</p></div></div></header>
 ...
 $body=ob_get_clean();layout($body,$u,$name);
}
