  ...
  case 'settings':
   ...
   <section class="tdcfg-page">
    ...
    <nav class="tdcfg-categories" aria-label="Áreas de configuração">
     ...
     <a href="#task-types"><span class="red"><i class="fa-regular fa-calendar-check"></i></span><strong>Agenda e tarefas</strong><small>Tipos e resultados padronizados</small></a>
