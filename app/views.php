...
function render(string $name,array $vars=[]): void{
 ...
 switch($name){
  ...
  case 'client':
   ...
   $crmInactive=!empty($client['crm_inactive']);
   ...
   $operationalAccess=!$crmInactive&&(($loggedUser['role']??'')!=='seller'||$effectiveSellerCode===''||$effectiveSellerCode===$loggedSellerCode);
   ...
   <section class="tdc-page">
    ...
    <?php elseif($pendingOmie&&!$crmInactive):?>
