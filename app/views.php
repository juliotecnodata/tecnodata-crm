   ...
   <section class="tdp-portfolio">
    ...
    <section class="tdp-table-card">
     <div class="tdp-table-wrap">
      <table class="tdp-table" data-datatable data-server-paged="1" data-page-length="10">
    ...
    <div class="tdc-detail-grid">
     <section class="tdc-card">
      ...
      <div class="tdc-info-grid">
       ...
       <div><span>Telefone</span><strong><?=e(trim(($formData['phone_ddd']?:'').' '.($formData['phone_number']?:''))?:'—')?></strong></div><div><span>Período de compra</span><strong><?=!empty($client['first_purchase_at'])?brdate((string)$client['first_purchase_at']).' → '.brdate((string)($client['last_purchase_at']??$client['first_purchase_at'])):'Sem compra identificada'?></strong><small>Pedidos e serviços válidos</small></div><div><span>Vendedor principal</span><strong><?=e((string)$principalSellerName)?></strong><small>Carteira efetiva: <?=e((string)$effectiveSellerName)?></small></div>
